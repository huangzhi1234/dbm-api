 ...
 * 商品信息表
 * */
public class EcsGoods implements java.io.Serializable {

	private static final long serialVersionUID = 1L;

	/******** 商品列表所需字段 开始 ********/
	private String goodsId;// 商品ID(自动增长)
	...
	private String goodsThumb;// 商品主图片 大图
	@JsonSerialize(using = UrlSerializer.class)
	private String originalImg;// 商品图片 小图
	private String brandName;// 品牌名称
	private Integer xiaoshou;// 销量
	private String sceneName;// 场景名称
	private String descImg;// 商品描述(showRoom)
	/******** 商品列表所需字段 结束 ********/
